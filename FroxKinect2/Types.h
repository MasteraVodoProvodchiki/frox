...
enum class EKinect2StreamType : uint8_t
{
	STREAM_ANY,
...
enum class EKinect2FormatType : uint8_t
{
...
struct Kinect2StreamProfile
{
	EKinect2StreamType StreamType = EKinect2StreamType::STREAM_ANY;
	EKinect2FormatType Format = EKinect2FormatType::FORMAT_ANY;
	int32_t Width = 640;
	int32_t Height = 480;
	int32_t Rate = 30;
};

struct Kinect2StreamMode
{
	int32_t Width = 640;
	int32_t Height = 480;
	int32_t Rate = 30;
